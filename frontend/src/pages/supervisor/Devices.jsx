    ...
    <div className="flex flex-col gap-6 relative pb-10">
      ...
      >
        <form id="fault-form" onSubmit={handleReportFault} className="flex flex-col gap-4 mt-1">
          <div className="bg-yellow-50 dark:bg-[rgba(245,158,11,0.08)] border border-yellow-200 dark:border-[rgba(245,158,11,0.2)] text-yellow-800 dark:text-[#FCD34D] p-2.5 rounded-lg flex items-start gap-2.5 text-sm">
